...
func main() {
	...
	fmt.Println(r.FindStringSubmatch("peach punch"))                   // [peach ea] - match and submatches
	fmt.Println(r.FindStringSubmatchIndex("peach punch"))              // [0 5 1 3] - match and submatches
