...
// PostProductsParams contains all the bound params for the post products operation
...
//
// To ensure default values, the struct must have been initialized with NewPostProductsParams() beforehand.
func (o *PostProductsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
