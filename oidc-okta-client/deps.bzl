...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_muhlemmer_gu",
        importpath = "github.com/muhlemmer/gu",
        sum = "h1:7EAqmFrW7n3hETvuAdmFmn4hS8W+z3LgKtrnow+YzNM=",
        version = "v0.3.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_zitadel_oidc_v2",
        importpath = "github.com/zitadel/oidc/v2",
        sum = "h1:JJUwTHtGCVJPtZh85GO1zzvh/QH52Fmim16sYVx8Dto=",
        version = "v2.6.2",
    )
    go_repository(
